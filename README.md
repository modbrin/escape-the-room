...
Game written in Haskell in a scope of CodeWorld Framework.
...
```
stack exec escape-the-room-exe
```

Then you can follow the link it will produce.
Game is played in browser.
